...
import { View, SafeAreaView, Image,Text,StyleSheet, Dimensions, TextInput, ScrollView, TouchableOpacity,StatusBar} from 'react-native'
...
// console.log('fat',setFat())
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.headView}>
                {/* <View style={styles.head1}> */}
                    ...
                    <View style={{justifyContent:'center'}}>
                        <Text style={{color:'white',fontSize:ht*0.028,fontWeight:"bold"}}>Body  Parameters</Text>
                    </View>
                {/* </View>
                <View style={styles.head2}> */}
                    <View style={{ justifyContent:'center'}}>
                        <Text style={{color:'#EFF0F1',fontSize:ht*0.016,alignItems:'flex-end'}}>{time}</Text>
                    </View>
                    <View style={{justifyContent:'center'}}>
                        <Text style={{color:'#EFF0F1',fontSize:ht*0.016}}>{date}</Text>
                    </View>
                {/* </View> */}
            </View>
            {/* image and BMI */}
            <View >
                <View style={styles.proview}>
                    ...
                    <View style={{width:wd,flexDirection:'row',justifyContent:'space-around',marginBottom:ht*0.01,marginTop:ht*0.01}}>
                        <View><Text style={{color:'rgb(9, 189, 234)',fontSize:ht*0.02,fontWeight:'bold'}}>Under Weight</Text></View>
                        <View><Text style={{color:'rgb(3, 119, 32)',fontSize:ht*0.02,fontWeight:'bold'}}>Normal</Text></View>
                        <View><Text style={{color:'rgb(237, 197, 40)',fontSize:ht*0.02,fontWeight:'bold'}}>Obese</Text></View>
                        <View><Text style={{color:'rgb(191, 65, 30)',fontSize:ht*0.02,fontWeight:'bold'}}>More Obese</Text></View>       
                    </View>
                </View>
            </View>
          ...
          <View style={styles.heightview}>
                ...
                <View style={styles.inputview}>
                    ...
                    <View style={{flex:1,flexDirection:'row'}}>
                        <View style={{flexDirection:'row',alignItems:'center',flex:1}}> 
                            <TextInput keyboardType={"numeric"} name='weight' value={values.weight} onChangeText={(e)=>handleChange(e,'weight')} style={styles.inputfield} />
                            <Text> kg</Text>
                        </View>
                        <View style={{flexDirection:'row',alignItems:"center"}}>
                            <AntDesign name="plus" size={12} color="black" style={{paddingRight:ht*0.009}} />
                ...
                <View style={{
                    ...
                    <View style={{flexDirection:'row',alignItems:'center',flex:1}}>
                        <Text style={{fontSize:ht*0.023}}>Circumfrence <Text style={{fontSize:ht*0.016}}> (in inches)</Text></Text>
                    </View>
                    <View > 
        ...
        <View style={{backgroundColor:'whitesmoke',elevation:5}}>
            <View style={styles.partsview}>
                <View style={styles.inputview}>
                    ...
                    <View style={{flex:1,flexDirection:'row'}}>
                        <View style={{flexDirection:'row',alignItems:'flex-end',flex:1}}> 
                            <TextInput keyboardType={"numeric"} name='neck' value={values.neck} onChangeText={(e)=>handleChange(e,'neck')} style={styles.inputfield} />
                ...
                <View style={styles.inputview}>
                    ...
                    <View style={{flex:1,flexDirection:'row'}}>
                        <View style={{flexDirection:'row',alignItems:'flex-end',flex:1}}> 
                            <TextInput keyboardType={"numeric"} name='arm' value={values.arm} onChangeText={(e)=>handleChange(e,'arm')} style={styles.inputfield} />
                ...
                <View style={styles.inputview}>
                    ...
                    <View style={{flex:1,flexDirection:'row'}}>
                        <View style={{flexDirection:'row',alignItems:'flex-end',flex:1}}> 
                            <TextInput keyboardType={"numeric"} name='wrist' value={values.wrist} onChangeText={(e)=>handleChange(e,'wrist')} style={styles.inputfield}  />
                ...
                <View style={styles.inputview}>
                    ...
                    <View style={{flex:1,flexDirection:'row'}}>
                        <View style={{flexDirection:'row',alignItems:'flex-end',flex:1}}> 
                            <TextInput keyboardType={"numeric"} name='waist' value={values.waist} onChangeText={(e)=>handleChange(e,'waist')} style={styles.inputfield} />
                ...
                <View style={styles.inputview}>
                    ...
                    <View style={{flex:1,flexDirection:'row'}}>
                        <View style={{flexDirection:'row',alignItems:'flex-end',flex:1}}> 
                            <TextInput keyboardType={"numeric"} name='fist' value={values.fist} onChangeText={(e)=>handleChange(e,'fist')} style={styles.inputfield} />
                ...
                <View style={styles.inputview}>  
                    ...
                    <View style={{flex:1,flexDirection:'row'}}>
                        <View style={{flexDirection:'row',alignItems:'flex-end',flex:1}}> 
                            <TextInput keyboardType={"numeric"} name='hip' value={values.hip} onChangeText={(e)=>handleChange(e,'hip')} style={styles.inputfield} />
               ...
               {/* BAR-1 */}
                <View style={{marginBottom:ht*0.01,marginTop:ht*0.02}}>
                    <View style={{flex:1,flexDirection:'row',justifyContent:'space-between'}}>
                        <Text style={{fontSize:ht*0.023}}>Waist to Height Ratio :- <Text style={{color:'tomato'}}>  {setWhr() <= 0 ? null : setWhr().toFixed(2) }    {WhrText()}</Text></Text>
                    ...
                    <View style={{padding:ht*0.02,marginTop:ht*0.008,marginRight:ht*0.02,elevation:6,backgroundColor:'white',borderRadius:ht*0.015}}>
                            <View style={{flexDirection:'row',flex:1,height:ht*0.013,position:'relative'}}>
                                ...
                                <View style={{flex:1,backgroundColor:'rgb(221, 86, 62)'}}></View>
                                <View style={{flex:2,backgroundColor:'rgb(119, 7, 7)',borderTopRightRadius:ht*0.01,borderBottomRightRadius:ht*0.01}}></View>
                           </View>
                    </View>
                </View>
                ...
                <View style={{marginBottom:ht*0.01,marginTop:ht*0.04}}>
                    ...
                    <View style={{padding:ht*0.02,marginTop:ht*0.008,marginRight:ht*0.02,elevation:6,backgroundColor:'white',borderRadius:ht*0.015}}>
                            <View style={{flexDirection:'row',flex:1,height:ht*0.013,position:'relative'}}>
                                ...
                                {/* <View style={{flex:1,backgroundColor:'rgb(77, 181, 63)'}}></View> */}
                                <View style={{flex:1,backgroundColor:'rgb(234, 205, 60)'}}></View>
                                <View style={{flex:0.8,backgroundColor:'rgb(221, 86, 62)'}}></View>
                                <View style={{flex:4.2,backgroundColor:'rgb(119, 7, 7)',borderTopRightRadius:ht*0.01,borderBottomRightRadius:ht*0.01}}></View>
                           </View>
                    </View> 
                </View>
           </View>
        ...
        <View style={{backgroundColor:'whitesmoke',elevation:5,padding:ht*0.008,position:'absolute',bottom:0,width:wd,flexDirection:'row',justifyContent:'space-around' }}>
            ...
            <TouchableOpacity>
                <MaterialCommunityIcons name="message-processing" size={24} color="rgb(104, 110, 117)" />
            </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
    ...
    inputfield:{
        ...
        borderColor:'black',paddingLeft:ht*0.006
    },
    partsview:{
        backgroundColor:'white',
